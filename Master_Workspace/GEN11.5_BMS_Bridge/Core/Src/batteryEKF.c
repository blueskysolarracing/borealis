...
void initEKFModel(EKF_Model_14p* inBattery, float initial_v){
    ...
    inBattery->matrix.dim1 = {3, 3};
    inBattery->matrix.dim2[2] = {3, 1};
    inBattery->matrix.dim3[2] = {1, 3};
    inBattery->matrix.dim4[2] = {1, 1};
    inBattery->matrix.dim5[2] = {3, 2};
    inBattery->matrix.dim6[2] = {2, 1};
    inBattery->matrix.dim7[2] = {1, 2};
