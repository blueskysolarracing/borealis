...
//			//Channel 2 is now used for motor
//			PSM->VDCOS_CH2 = 10.979409 / ((1.2) / 8388607.0 * (1.0 + 664.0*(1.0/2.2 + 1.0/480.0))) + 1.729498*88474.0;
//			PSM->CDCOS_CH2 = 0.0969 / ((1.2) / 8388607.0 / 0.5) + 1.0239*88474.0; //0.0969
//			PSM->VM_CH2 = 0.6429207921 * (1.2) / 8388607.0 * (1.0 + 664.0*(1.0/2.2 + 1.0/480.0));
//			PSM->CM_CH2 = 40.9836065574 * (1.2) / 8388607.0 / 0.5;
//
//			break;
//
//		case 3: //PSM in PPT box
//			PSM->VDCOS_CH1 = 10.929442 / ((1.2) / 8388607 * (1 + 664*(1/2.2 + 1/480))) + 1.56999*88474.0; //10.929442;
//			PSM->CDCOS_CH1 = 0.02728780017260 / ((1.2) / 8388607 / 2); //1.105273;
//			PSM->VM_CH1 = 0.644902 * (1.2) / 8388607 * (1 + 664*(1/2.2 + 1/480)); //2.2kR; 0.644902
//			PSM->CM_CH1 = 40.434174 * (1.2) / 8388607 / 2; //2mR; 40.434174
//
//			PSM->VDCOS_CH2 = 10.922863 / ((1.2) / 8388607 * (1 + 664*(1/2.2 + 1/480))) + 1.54599*88474.0; //10.922863;
//			PSM->CDCOS_CH2 = 0.11002681 / ((1.2) / 8388607 / 0.5); //4.524961;
//			PSM->VM_CH2 = 0.648049 * (1.2) / 8388607 * (1 + 664*(1/2.2 + 1/480)); //2.2kR; 0.648049
//			PSM->CM_CH2 = 40.640790 * (1.2) / 8388607 / 0.5; //0.5mR; 40.640790
//
//			PSM->VDCOS_CH3 = 10.647904 / ((1.2) / 8388607 * (1 + 664*(1/2.2 + 1/480))) + 1.547899*88474.0; //10.647904;
//			PSM->CDCOS_CH3 = 0.0268780017260 / ((1.2) / 8388607 / 2); //1.072620;
//			PSM->VM_CH3 = 0.646083 * (1.2) / 8388607 * (1 + 664*(1/2.2 + 1/480)); //2.2kR; 0.646083
//			PSM->CM_CH3 = 40.377955 * (1.2) / 8388607 / 2; //2mR; 40.377955
//
//			PSM->VDCOS_CH4 = 10.828361 / ((1.2) / 8388607 * (1 + 664*(1/2.2 + 1/480))) + 1.557999*88474.0; //10.828361;
//			PSM->CDCOS_CH4 = 0.0269990017260 / ((1.2) / 8388607 / 2); //1.139373;
