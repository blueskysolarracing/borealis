...
clr TMR4
mov #487, w0 ; set the timer frequency to 32787 Hz, hence our bit-14 (what does this bit 14 event mean i think refers to interrupt) event occurs at almost exactly 1 second.
;mov #1, w0
mov w0, PR4
...
;                             5432109876543210
.equ TIMEKEEPER_FLAGS_MASK, 0b0110000000010000 
    ; this is IFS0 register bitmask: 
    ; shift 4 -> DMA ch 0 satta transfer complete, 
    ; Shift 10 -> SPI? 
    ; shift 11 -> UART1 Recieve
    ; shift 13 -> ADC1 done
    ; shift 14 -> DMA ch 1 done
