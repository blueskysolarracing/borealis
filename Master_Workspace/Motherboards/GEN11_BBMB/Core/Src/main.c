...
int main(void)
{
  ...
  psmPeriph.motherboard = BBMB_PSM;
...
void lightsTask(void * argument){
	uint8_t buf_get[10];
	float indicator_brightness = 0.2; //Don't go over 40%
	float DRL_brightness = 0.2; //Don't go over 50%
	float brake_brightness = 0.2; //Don't go over 50%
	float hazard_brightness = 0.2; //Don't go over 50%
	float BPS_fault_brightness = 0.2; //Don't go over 50%
