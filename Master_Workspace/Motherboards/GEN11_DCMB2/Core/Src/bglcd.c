...
void drawP2Detailed_1(/*int value[9]*/){
	...
	// populate label
	if(value[0] >= 0) sprintf(labelsP1[0], "Solar:+%4dW(%3dV,%2dA)\0", value[0], abs(value[3]), abs(currents[0]));
	else sprintf(labelsP1[0], "Solar:+%4dW(%3dV,%2d.%1dA)\0", abs(value[0]), abs(value[3]), abs(currents[0]));

	if(value[1] >= 0) sprintf(labelsP1[1], "Motor:+%4dW(%3dV,%2dA)\0", value[1], abs(value[4]), abs(currents[1]));
	else sprintf(labelsP1[1], "Motor:+%4dW(%3dV,%2d.%1dA)\0", abs(value[1]), abs(value[4]), abs(currents[1]));

	if(value[2] >= 0) sprintf(labelsP1[2], "Batt: +%4dW(%3dV,%2dA)\0", value[2], abs(value[5]), abs(currents[2]));
	else sprintf(labelsP1[2], "Batt: +%4dW(%3dV,%2dA)\0", abs(value[2]), abs(value[5]), abs(currents[2]));
