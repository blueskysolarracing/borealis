...
#define MIN_PWM_DUTY_CYCLE 			0.02 	//Minimum allowed PWM duty cycle
...
#define NUM_UMPPT 					3 		//Number of uMPPT on the board (1 to 5). Assumes that uMPPT are populated from #1 upwards and unused uMPPT are jumped
#define MAX_SPI_TIMEOUT 			100

#define ADC_VA						5
#define ADC_LSB_WIDTH				((float)(ADC_VA)/(float)(4096))
#define ADC_BIT_TRANSITION			((float)(ADC_VA)/(float)(8192))
