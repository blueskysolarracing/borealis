...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/freertos.d ./Core/Src/freertos.o ./Core/Src/glcd.d ./Core/Src/glcd.o ./Core/Src/graphics.d ./Core/Src/graphics.o ./Core/Src/graphs.d ./Core/Src/graphs.o ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_timebase_tim.d ./Core/Src/stm32f4xx_hal_timebase_tim.o ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/text.d ./Core/Src/text.o ./Core/Src/text_tiny.d ./Core/Src/text_tiny.o ./Core/Src/unit_tests.d ./Core/Src/unit_tests.o
